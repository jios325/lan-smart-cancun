				...
				<div class="tabs--section tabs-image--container tabs-navbar">
					...
					<nav>
						<ul>
							...
							<li class="tabs-image--item bares small gotoSlide tab2">
								<label for="tab2">
									<div class="gradient-card-shadow"></div>
									<div class="tabs-image--item-container backgrounds gradient-after">
										<div class="tabs-image--item-content">
					...
					<section  class="tabs--slide">
						<div class="tab1">
							...
							<div class="main-section__rest_y_bares--cards tab1 viewmore_contenido slide_mobile slick-arrow-out slick-arrow-dark" data-rows="2" data-slidesperrow="1">
						...
						<div class="tab2">
							...
							<div class="main-section__rest_y_bares--cards tab2 viewmore_contenido slide_mobile slick-arrow-out slick-arrow-dark" data-rows="2" data-slidesperrow="1">
