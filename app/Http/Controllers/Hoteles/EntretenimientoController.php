...
class EntretenimientoController extends Controller
{
    ...
    public function index(Http $request){
        ...
        if(($slug == 'the-pyramid-at-grand-oasis') || ($slug == 'grand-oasis-cancun') || ($slug == 'oasis-cancun-lite') || ($slug == 'the-sian-ka-an-at-grand-sens') || ($slug == 'grand-oasis-sens')){
            ...
            abort(404, 'Este hotel no tiene esta seccion');   
        }
    }
}